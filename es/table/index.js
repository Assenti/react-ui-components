...
var compare = function compare(a, b, key, sortType) {
  if (sortType === 'desc') {
...
export var Table = function Table(props) {
  ...
  var _useState11 = useState(initialHeaders()),
  ...
  return React.createElement("div", {
    ...
    className: "table__footer row space-between"
    ...
    className: "table__placeholder"
  }, React.createElement(Empty, null)) : '', props.loading ? React.createElement("div", {
    className: props.loading ? 'table__placeholder loading' : 'table__placeholder'
