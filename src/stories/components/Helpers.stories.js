...
const Template = () => (
    <div className="rui-page">
        ...
        <Card header={<h4>Margins & Paddings</h4>}>
        ...
        <br/>
        <Card header={<h4>Font size and weight</h4>}>
            <Table
                bordered
        ...
        <br/>
        <Card header={<h4>Text alignment</h4>}>
            <Table
                bordered
                headers={['Class', 'Description']}
                items={textStyles}
