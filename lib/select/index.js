...
export var Select = function Select(_ref) {
  ...
  var selectSubItemClass = function selectSubItemClass(item) {
    ...
    return "rui-select-menu__subitem ".concat(classes.normalTitle, " ").concat(classes.active);
  };
  ...
  return React.createElement(React.Fragment, null, labelName ? React.createElement("label", {
    className: "rui-select-menu__label"
    ...
    className: "rui-select-menu__value",
    onClick: openMenu,
    title: selectedItem
    ...
    className: "rui-select-menu__items"
    ...
    return React.createElement("div", {
      ...
      className: "rui-select-menu__subitems"
    }, subTitle ? React.createElement("div", {
      className: "rui-select-menu__subitem-title"
