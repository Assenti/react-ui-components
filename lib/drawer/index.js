...
var Drawer = function Drawer(props) {
  ...
  var handleCloseXs = function handleCloseXs(e) {
    e.preventDefault();
  ...
  var drawerOverlayClass = function drawerOverlayClass() {
    return props.drawer ? 'rui-drawer__overlay' : 'rui-drawer__overlay none';
  };

  return React.createElement(React.Fragment, null, isXs || props.absolute ? React.createElement(CSSTransition, {
    in: props.drawer,
    timeout: 100,
