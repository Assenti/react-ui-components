...
var Table = function Table(props) {
  ...
  var prepareHeaders = function prepareHeaders() {
    if (props.sortable && !props.checkbox) {
      return React.createElement("tr", null, isIndexedTable(), headers.map(function (item, index) {
      ...
      return React.createElement("tr", null, isIndexedTable(), React.createElement("th", {
        style: {
          maxWidth: 40,
          width: 40
        }
      ...
      return React.createElement("tr", null, isIndexedTable(), React.createElement("th", null, React.createElement(Checkbox, {
        color: props.color ? props.color : '',
        onChange: function onChange() {
          return props.checkbox ? onSelectAll() : {};
        },
